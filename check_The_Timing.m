...
comments           = comments1([false true diff(cell2mat(trial_NumArray))'==1]);
...
% diff([comments(1); stim_OffTime2(1:12)'; comments([14 15])'; stim_OffTime2(14:61)';...
%     comments([64 65])';stim_OffTime2(63:90)';comments([94 95])';stim_OffTime2(92:end)'])
